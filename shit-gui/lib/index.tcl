# shit-gui index (add/remove) support
# Copyright (C) 2006, 2007 Shawn Pearce

proc _delete_indexlock {} {
	if {[catch {file delete -- [shitdir index.lock]} err]} {
...
proc rescan_on_error {err {after {}}} {
	...
	set s [mc "Updating the shit index failed.  A rescan will be automatically started to resynchronize shit-gui."]
...
proc update_indexinfo {msg path_list after} {
	...
	set fd [shit_write update-index -z --index-info]
	fconfigure $fd \
		-blocking 0 \
		-buffering full \
		-buffersize 512 \
...
proc update_index {msg path_list after} {
	...
	set status_bar_operation [$::main_status start $msg [mc "files"]]
	set fd [shit_write update-index --add --remove -z --stdin]
	fconfigure $fd \
		-blocking 0 \
		-buffering full \
		-buffersize 512 \
...
proc checkout_index {msg path_list after capture_error} {
	...
	set status_bar_operation [$::main_status start $msg [mc "files"]]
	set fd [shit_write checkout-index \
		--index \
		--quiet \
		--force \
		-z \
