# shit-gui encoding support
# Copyright (C) 2005 Paul Mackerras <paulus@samba.org>
# (Copied from shitk, commit fd8ccbec4f0161)
...
proc build_encoding_table {} {
	...
	# of compatibility issues with older Tcl (e.g. in msysshit)
	set names [list]
...
proc get_path_encoding {path} {
	...
	if {$path ne {}} {
		if {[info exists path_encoding_overrides($path)]} {
			...
			set enc2 [tcl_encoding [shitattr $path encoding $tcl_enc]]
		}
		if {$enc2 ne {}} {
			set tcl_enc $enc2
		}
