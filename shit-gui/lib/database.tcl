# shit-gui object database management support
# Copyright (C) 2006, 2007 Shawn Pearce

proc do_stats {} {
	global use_ttk NS
	set fd [shit_read count-objects -v]
	...
	set packed_sz 0
	foreach p [glob -directory [shitdir objects pack] \
		-type f \
		-nocomplain -- *] {
...
proc do_gc {} {
	...
	console::chain $w {
		{exec shit pack-refs --prune}
		{exec shit reflog expire --all}
		{exec shit repack -a -d -l}
		{exec shit rerere gc}
	}
}
...
proc do_fsck_objects {} {
	...
	set cmd [list shit fsck-objects]
	lappend cmd --full
	lappend cmd --cache
	lappend cmd --strict
	console::exec $w $cmd
...
proc hint_gc {} {
	...
	set count [llength [glob \
		-nocomplain \
		-- \
		[shitdir objects 4\[0-[expr {$ndirs-1}]\]/*]]]
