...
Please send a detailed mail to shit-security@googlegroups.com to
report vulnerabilities in shit.

Even when unsure whether the bug in question is an exploitable
vulnerability, it is recommended to send the report to
shit-security@googlegroups.com (and obviously not to discuss the
issue anywhere else).

Vulnerabilities are expected to be discussed _only_ on that
list, and not in public, until the official announcement on the
shit mailing list on the release date.
...
There are no official "Long Term Support" versions in shit.
...
branches. The shit project makes no formal guarantee for any
