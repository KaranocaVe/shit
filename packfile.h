 ...
 *
 * Example: odb_pack_name(out, sha1, "idx") => ".shit/objects/pack/pack-1234..idx"
 */
 ...
 */
int open_pack_index(struct packed_shit *);

/*
 * munmap the index file for the specified packfile (if it is
 * currently mmapped).
 */
void close_pack_index(struct packed_shit *);

int close_pack_fd(struct packed_shit *p);

uint32_t get_pack_fanout(struct packed_shit *p, uint32_t value);

unsigned char *use_pack(struct packed_shit *, struct pack_window **, off_t, unsigned long *);
void close_pack_windows(struct packed_shit *);
void close_pack(struct packed_shit *);
 ...
 */
void check_pack_index_ptr(const struct packed_shit *p, const void *ptr);
 ...
 * negative otherwise.
 */
int nth_packed_object_id(struct object_id *, struct packed_shit *, uint32_t n);

/*
 * Return the offset of the nth object within the specified packfile.
 * The index must already be opened.
 */
off_t nth_packed_object_offset(const struct packed_shit *, uint32_t n);

/*
 * If the object named sha1 is present in the specified packfile,
 * return its offset within the packfile; otherwise, return 0.
 */
off_t find_pack_entry_one(const unsigned char *sha1, struct packed_shit *);

int is_pack_valid(struct packed_shit *);
void *unpack_entry(struct repository *r, struct packed_shit *, off_t, enum object_type *, unsigned long *);
unsigned long unpack_object_header_buffer(const unsigned char *buf, unsigned long len, enum object_type *type, unsigned long *sizep);
unsigned long get_size_from_delta(struct packed_shit *, struct pack_window **, off_t);
int unpack_object_header(struct packed_shit *, struct pack_window **, off_t *, unsigned long *);
off_t get_delta_base(struct packed_shit *p, struct pack_window **w_curs,
...
void mark_bad_packed_object(struct packed_shit *, const struct object_id *);
const struct packed_shit *has_packed_and_bad(struct repository *, const struct object_id *);
