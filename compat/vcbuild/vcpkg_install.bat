...
REM it to build the third-party libraries that shit requires when it
...
REM https://shithub.com/Microsoft/vcpkg
...
REM ================================================================
	...
	shit.exe clone https://shithub.com/Microsoft/vcpkg vcpkg
