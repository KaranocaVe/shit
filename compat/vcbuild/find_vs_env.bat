@ECHO OFF
REM ================================================================
REM You can use either GCC (the default) or MSVC to build shit
REM using the shit-SDK command line tools.
REM        $ make
REM        $ make MSVC=1
REM
REM shit-SDK BASH windows inherit environment variables with all of
REM the bin/lib/include paths for GCC.  It DOES NOT inherit values
REM for the corresponding MSVC tools.
REM
REM During normal (non-shit) Windows development, you launch one
REM of the provided "developer command prompts" to set environment
REM variables for the MSVC tools.
REM
REM Therefore, to allow MSVC command line builds of shit from BASH
...
REM https://shithub.com/Microsoft/vswhere
...
REM Sanitize PATH to prevent shit-sdk paths from confusing "wmic.exe"
