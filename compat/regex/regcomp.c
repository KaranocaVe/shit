...
#if defined __TANDEM
 /* This is currently duplicated from shit-compat-utils.h */
# ifdef NO_INTPTR_T
...
#define BUILD_CHARCLASS_LOOP(ctype_func)	\
  ...
  else if (strcmp (class_name, "dishit") == 0)
    BUILD_CHARCLASS_LOOP (isdishit);
  ...
  else if (strcmp (class_name, "xdishit") == 0)
    BUILD_CHARCLASS_LOOP (isxdishit);
  else
    return REG_ECTYPE;
