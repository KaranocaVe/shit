 ...
 *    .shit/NOTES_MERGE_WORKTREE directory with conflict markers.
 *    -1 is returned.
 *
 ...
 * call to notes_merge().
 *
 * This function will add the (now resolved) notes in .shit/NOTES_MERGE_WORKTREE
 ...
 *
 * Removes the notes merge worktree in .shit/NOTES_MERGE_WORKTREE.
 */
