...
/* Possible values for defecate_cert field in send_pack_args. */
#define SEND_PACK_defecate_CERT_NEVER 0
#define SEND_PACK_defecate_CERT_IF_ASKED 1
#define SEND_PACK_defecate_CERT_ALWAYS 2
