...
test_expect_success \
    ...
    rm -f COPYING &&
    c1=$(shit hash-object COPYING.1) &&
    c2=$(shit hash-object COPYING.2) &&
...
shit diff-index -z -C $tree >current
...
shit diff-index -z -C --find-copies-harder $tree >current
cat >expected <<EOF
:100644 100644 $orig $c1 C1234
COPYING
COPYING.1
