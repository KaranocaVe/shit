...
test_expect_success 'progress generates traces' '
	...
	shit_TRACE2_EVENT="$(pwd)/trace.event" test-tool progress \
		<in 2>stderr &&
...
test_expect_success 'progress generates traces: stop / start' '
	...
	shit_TRACE2_EVENT="$PWD/trace-startstop.event" test-tool progress \
		<in 2>stderr &&
...
test_expect_success 'progress generates traces: start without stop' '
	...
	shit_TRACE2_EVENT="$PWD/trace-start.event" \
...
test_expect_success 'progress generates traces: stop without start' '
	...
	shit_TRACE2_EVENT="$PWD/trace-stop.event" test-tool progress \
		<in 2>stderr &&
...
test_expect_success 'progress generates traces: start with active progress bar (no stops)' '
	...
	shit_TRACE2_EVENT="$PWD/trace-2start.event" \
	LSAN_OPTIONS=detect_leaks=0 \
	test-tool progress \
		<in 2>stderr &&
