...
test_expect_success 'test refspec globbing' '
	...
	test "$(shit rev-parse refs/remotes/tags/end~1)" = \
		"$(shit rev-parse refs/remotes/branches/start)" &&
	test "$(shit rev-parse refs/remotes/branches/start~2)" = \
...
test_expect_success 'test left-hand-side only globbing' '
	...
	shit rev-list refs/remotes/two/branches/start >actual &&
	test_line_count = 3 actual &&
	test $(shit rev-parse refs/remotes/two/branches/start~2) = \
	     $(shit rev-parse refs/remotes/two/trunk) &&
	test $(shit rev-parse refs/remotes/two/tags/end~3) = \
	     $(shit rev-parse refs/remotes/two/branches/start) &&
