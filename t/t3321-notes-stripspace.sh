...
test_expect_success 'add note by editor' '
	test_when_finished "shit notes remove" &&
	cat >expect <<-EOF &&
	first-line
	...
	MSG="${LF}first-line${MULTI_LF}second-line${LF}" shit notes add  &&
...
test_expect_success 'add note by specifying single "-m", "--stripspace" is the default behavior' '
	...
	shit notes add -m "${LF}first-line${MULTI_LF}second-line${LF}" &&
	shit notes show >actual &&
	test_cmp expect actual &&
	shit notes remove &&
	shit notes add --stripspace -m "${LF}first-line${MULTI_LF}second-line${LF}" &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'add note by specifying multiple "-m", "--stripspace" is the default behavior' '
	...
	test_cmp expect actual &&
	shit notes remove &&
	shit notes add --stripspace -m "${LF}" \
		      -m "first-line" \
		      -m "${MULTI_LF}" \
		      -m "second-line" \
		      -m "${LF}" &&
...
test_expect_success 'add note by specifying single "-F", "--stripspace" is the default behavior' '
	...
	shit notes add -F note-file &&
	shit notes show >actual &&
	test_cmp expect actual &&
	shit notes remove &&
	shit notes add --stripspace -F note-file &&
	shit notes show >actual
'
...
test_expect_success 'add note by specifying single "-F" and "--no-stripspace"' '
	...
	shit notes add --no-stripspace -F note-file &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'add note by specifying multiple "-F", "--stripspace" is the default behavior' '
	...
	shit notes add -F note-file-1 -F note-file-2 &&
	shit notes show >actual &&
	test_cmp expect actual &&
	shit notes remove &&
	shit notes add --stripspace -F note-file-1 -F note-file-2 &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'add note by specifying multiple "-F" with "--no-stripspace"' '
	...
	shit notes add --no-stripspace -F note-file-1 -F note-file-2 &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'append note by editor' '
	...
	shit notes add -m "first-line" &&
	MSG="${MULTI_LF}second-line${LF}" shit notes append  &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'append note by specifying single "-m"' '
	...
	shit notes add -m "${LF}first-line" &&
	shit notes append -m "${MULTI_LF}second-line${LF}" &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'append note by specifying single "-F"' '
	...
	shit notes add -m "initial-line" &&
	shit notes append -F note-file &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'append notes by specifying multiple "-F"' '
	...
	shit notes add -m "initial-line" &&
	shit notes append -F note-file-1 -F note-file-2 &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'append note by specifying multiple "-F" with "--no-stripspace"' '
	...
	shit notes add -m "initial-line" &&
	shit notes append --no-stripspace -F note-file-1 -F note-file-2 &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'add note by specifying "-C", "--no-stripspace" is the default behavior' '
	...
	shit hash-object -w --stdin <expect >blob &&
	shit notes add -C $(cat blob) &&
	shit notes show >actual &&
	test_cmp expect actual &&
	shit notes remove &&
	shit notes add --no-stripspace -C $(cat blob) &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'reuse note by specifying "-C" and "--stripspace"' '
	...
	shit hash-object -w --stdin <data >blob &&
	shit notes add --stripspace -C $(cat blob) &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'reuse with "-C" and add note with "-m", "-m" will stripspace all together' '
	...
	shit hash-object -w --stdin <data >blob &&
	shit notes add -C $(cat blob) -m "third-line" &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'add note with "-m" and reuse note with "-C", "-C" will not stripspace all together' '
	...
	shit hash-object -w --stdin <data >blob &&
	shit notes add -m "first-line" -C $(cat blob)  &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'add note by specifying "-c", "--stripspace" is the default behavior' '
	...
	echo "initial-line" | shit hash-object -w --stdin >blob &&
	MSG="${LF}first-line${MULTI_LF}second-line${LF}" shit notes add -c $(cat blob) &&
	shit notes show >actual &&
	test_cmp expect actual &&
	shit notes remove &&
	MSG="${LF}first-line${MULTI_LF}second-line${LF}" shit notes add --stripspace -c $(cat blob) &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'add note by specifying "-c" with "--no-stripspace"' '
	...
	echo "initial-line" | shit hash-object -w --stdin >blob &&
	MSG="${LF}first-line${MULTI_LF}second-line${LF}" shit notes add --no-stripspace -c $(cat blob) &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'edit note by specifying "-c", "--stripspace" is the default behavior' '
	...
	MSG="${LF}first-line${MULTI_LF}second-line${LF}" shit notes edit &&
	shit notes show >actual &&
	test_cmp expect actual &&
	shit notes remove &&
	MSG="${LF}first-line${MULTI_LF}second-line${LF}" shit notes edit --stripspace &&
	shit notes show >actual &&
	test_cmp expect actual
'
...
test_expect_success 'edit note by specifying "-c" with "--no-stripspace"' '
	...
	MSG="${LF}first-line${MULTI_LF}second-line${LF}" shit notes add --no-stripspace &&
	shit notes show >actual &&
	test_cmp expect actual
'
