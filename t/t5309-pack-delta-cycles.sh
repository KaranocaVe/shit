...
test_expect_success 'index-pack detects missing base objects' '
	...
	test_must_fail shit index-pack --fix-thin --stdin <missing.pack
'
...
test_expect_success 'index-pack detects REF_DELTA cycles' '
	...
	test_must_fail shit index-pack --fix-thin --stdin <cycle.pack
'

test_expect_success 'failover to an object in another pack' '
	clear_packs &&
	shit index-pack --stdin <ab.pack &&
	test_must_fail shit index-pack --stdin --fix-thin <cycle.pack
'
...
test_expect_success 'failover to a duplicate object in the same pack' '
	...
	test_must_fail shit index-pack --fix-thin --stdin <recoverable.pack
'
