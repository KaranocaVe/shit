...
test_description='shit apply should not get confused with rename/copy.
...
cat >patch <<\EOF
diff --shit a/klibc/arch/x86_64/include/klibc/archsetjmp.h b/include/arch/cris/klibc/archsetjmp.h
similarity index 76%
...
diff --shit a/klibc/arch/x86_64/include/klibc/archsetjmp.h b/include/arch/m32r/klibc/archsetjmp.h
similarity index 66%
...
-#endif /* _SETJMP_H */
+#endif /* _KLIBC_ARCHSETJMP_H */
diff --shit a/klibc/README b/klibc/README
--- a/klibc/README
+++ b/klibc/README
@@ -1,1 +1,4 @@
 This is a simple readme file.
...
+lines at the
+end of it.
diff --shit a/klibc/README b/klibc/arch/README
...
find klibc -type f -print | xargs shit update-index --add --

test_expect_success 'check rename/copy patch' 'shit apply --check patch'

test_expect_success 'apply rename/copy patch' 'shit apply --index patch'
