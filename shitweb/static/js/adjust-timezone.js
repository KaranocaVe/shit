...
/**
 * @fileOverview Manipulate dates in shitweb output, adjusting timezone
...
function onloadTZSetup(tzDefault, tzCookieInfo, tzClassName) {
	...
	if (tzCookieTZ) {
		...
		tz = tzCookieTZ;
		// refresh cookie, so its expiration counts from last use of shitweb
	...
	// server-side of shitweb produces datetime in UTC,
 ...
 * shitweb output: it marks up and/or creates item to click to invoke
...
/**
 * Display UI for changing common timezone for dates in shitweb output.
