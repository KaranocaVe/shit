...
void prepare_packing_data(struct repository *r, struct packing_data *pdata)
{
	...
	if (shit_env_bool("shit_TEST_FULL_IN_PACK_ARRAY", 0)) {
		/*
	...
	pdata->oe_size_limit = shit_env_ulong("shit_TEST_OE_SIZE",
					     1U << OE_SIZE_BITS);
	pdata->oe_delta_size_limit = shit_env_ulong("shit_TEST_OE_DELTA_SIZE",
