 ...
 * unnecessary parsing of the same .shitmodules files. Lookups can be done by
...
struct submodule {
	...
	/* the object id of the responsible .shitmodules file */
 ...
 * (e.g., that may be found in the subsection of a .shitmodules file) and -1
 * otherwise.
 */
 ...
 * '.shitmodules'.
 *
 * New helpers to retrieve arbitrary configuration from the '.shitmodules' file
 * should NOT be added.
 */
